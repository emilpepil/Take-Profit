...
/// @title PolicyVault
/// @notice Testnet-only vault that turns a spot-price policy into protected SimplePool swaps.
/// @dev The pool's spot price is manipulable; this is intentionally a controlled demo, not production oracle logic.
contract PolicyVault is Ownable, ReentrancyGuard {
    ...
    constructor(
        ...
        address owner_,
        address keeper_,
        uint256 takeProfitPriceE18_,
        uint256 rebalancePriceE18_,
        uint16 tradeBps_,
